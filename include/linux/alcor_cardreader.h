...
#ifndef __ALCOR_CARDREADER_H
#define __ALCOR_CARDREADER_H

#define DRVNAME_ALCOR_PCI			"alcor_pci"
#define DRVNAME_ALCOR_PCI_SDMMC			"alcor_pci_sdmmc"
#define DRVNAME_ALCOR_PCI_MS			"alcor_pci_ms"
