...
#define SYSREG_OFFSET		0x20
#define HW_AHBCLKCTRL0		(0x0020 - SYSREG_OFFSET)
#define HW_AHBCLKCTRL1		(0x0030 - SYSREG_OFFSET)
#define HW_SYSPLLCTRL		(0x0100 - SYSREG_OFFSET)
#define HW_MAINCLKSEL		(0x0120 - SYSREG_OFFSET)
#define HW_MAINCLKUEN		(0x0124 - SYSREG_OFFSET)
#define HW_UARTCLKSEL		(0x0128 - SYSREG_OFFSET)
#define HW_UARTCLKUEN		(0x012c - SYSREG_OFFSET)
#define HW_I2S0CLKSEL		(0x0130 - SYSREG_OFFSET)
#define HW_I2S0CLKUEN		(0x0134 - SYSREG_OFFSET)
#define HW_I2S1CLKSEL		(0x0138 - SYSREG_OFFSET)
#define HW_I2S1CLKUEN		(0x013c - SYSREG_OFFSET)
#define HW_WDTCLKSEL		(0x0160 - SYSREG_OFFSET)
#define HW_WDTCLKUEN		(0x0164 - SYSREG_OFFSET)
#define HW_CLKOUTCLKSEL		(0x0170 - SYSREG_OFFSET)
#define HW_CLKOUTCLKUEN		(0x0174 - SYSREG_OFFSET)
#define HW_CPUCLKDIV		(0x017c - SYSREG_OFFSET)
#define HW_SYSAHBCLKDIV		(0x0180 - SYSREG_OFFSET)
#define HW_I2S0MCLKDIV		(0x0190 - SYSREG_OFFSET)
#define HW_I2S0SCLKDIV		(0x0194 - SYSREG_OFFSET)
#define HW_I2S1MCLKDIV		(0x0188 - SYSREG_OFFSET)
#define HW_I2S1SCLKDIV		(0x018c - SYSREG_OFFSET)
#define HW_UART0CLKDIV		(0x0198 - SYSREG_OFFSET)
#define HW_UART1CLKDIV		(0x019c - SYSREG_OFFSET)
#define HW_UART2CLKDIV		(0x01a0 - SYSREG_OFFSET)
#define HW_UART3CLKDIV		(0x01a4 - SYSREG_OFFSET)
#define HW_UART4CLKDIV		(0x01a8 - SYSREG_OFFSET)
#define HW_UART5CLKDIV		(0x01ac - SYSREG_OFFSET)
#define HW_UART6CLKDIV		(0x01b0 - SYSREG_OFFSET)
#define HW_UART7CLKDIV		(0x01b4 - SYSREG_OFFSET)
#define HW_UART8CLKDIV		(0x01b8 - SYSREG_OFFSET)
#define HW_UART9CLKDIV		(0x01bc - SYSREG_OFFSET)
#define HW_SPI0CLKDIV		(0x01c0 - SYSREG_OFFSET)
#define HW_SPI1CLKDIV		(0x01c4 - SYSREG_OFFSET)
#define HW_QUADSPICLKDIV	(0x01c8 - SYSREG_OFFSET)
#define HW_SSP0CLKDIV		(0x01d0 - SYSREG_OFFSET)
#define HW_NANDCLKDIV		(0x01d4 - SYSREG_OFFSET)
#define HW_TRACECLKDIV		(0x01e0 - SYSREG_OFFSET)
#define HW_CAMMCLKDIV		(0x01e8 - SYSREG_OFFSET)
#define HW_WDTCLKDIV		(0x01ec - SYSREG_OFFSET)
#define HW_CLKOUTCLKDIV		(0x01f4 - SYSREG_OFFSET)
#define HW_MACCLKDIV		(0x01f8 - SYSREG_OFFSET)
#define HW_LCDCLKDIV		(0x01fc - SYSREG_OFFSET)
#define HW_ADCANACLKDIV		(0x0200 - SYSREG_OFFSET)
